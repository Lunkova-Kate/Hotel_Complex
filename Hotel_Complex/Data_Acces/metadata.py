TABLES_META = {
    'building_type': {
        'pk': 'building_type_id',
        'fields': [
            {'name': 'building_type_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'building': {
        'pk': 'building_id',
        'fields': [
            {'name': 'building_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'room_type': {
        'pk': 'room_type_id',
        'fields': [
            {'name': 'room_type_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
            {'name': 'name', 'label': 'Название', 'type': 'str', 'required': True, 'maxlen': 100},
    ...
    'room': {
        'pk': 'room_id',
        'fields': [
            {'name': 'room_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'service_type': {
        'pk': 'service_type_id',
        'fields': [
            {'name': 'service_type_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'organization_type': {
        ...
        'fields': [
            {'name': 'organization_type_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'organization': {
        'pk': 'organization_id',
        'fields': [
            {'name': 'organization_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'organization_tour_agency': {
        'pk': 'organization_id',
        'fields': [
            {'name': 'organization_id', 'label': 'Организация', 'type': 'fk', 'ref_table': 'organization', 'display_col': 'name', 'required': True, 'is_pk': True},
    ...
    'contract': {
        'pk': 'contract_id',
        'fields': [
            {'name': 'contract_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'client': {
        'pk': 'client_id',
        'fields': [
            {'name': 'client_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'booking': {
        'pk': 'booking_id',
        'fields': [
            {'name': 'booking_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'stay': {
        'pk': 'stay_id',
        'fields': [
            {'name': 'stay_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'room_tariff': {
        'pk': 'tariff_id',
        'fields': [
            {'name': 'tariff_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
            {'name': 'building_type_id', 'label': 'Тип корпуса', 'type': 'fk', 'ref_table': 'building_type', 'display_col': 'name', 'required': True},
            {'name': 'room_type_id', 'label': 'Тип номера', 'type': 'fk', 'ref_table': 'room_type', 'display_col': 'name', 'required': True},
    ...
    'service_usage': {
        'pk': 'usage_id',
        'fields': [
            {'name': 'usage_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'invoice': {
        'pk': 'invoice_id',
        'fields': [
            {'name': 'invoice_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'penalty': {
        'pk': 'penalty_id',
        'fields': [
            {'name': 'penalty_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
            {'name': 'stay_id', 'label': 'Проживание', 'type': 'fk', 'ref_table': 'stay', 'display_col': 'stay_id', 'required': True},
    ...
    'payment': {
        'pk': 'payment_id',
        'fields': [
            {'name': 'payment_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'complaint': {
        'pk': 'complaint_id',
        'fields': [
            {'name': 'complaint_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
    ...
    'review': {
        'pk': 'review_id',
        'fields': [
            {'name': 'review_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
            {'name': 'client_id', 'label': 'Клиент', 'type': 'fk', 'ref_table': 'client', 'display_col': 'last_name', 'required': True},
    ...
    'expense': {
        'pk': 'expense_id',
        'fields': [
            {'name': 'expense_id', 'label': 'ID', 'type': 'int', 'editable': False, 'is_pk': True},
